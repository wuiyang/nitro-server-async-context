...
declare module "nitropack" {
  interface NitroRuntimeHooks {
    ...
    "async-context:create": (contextObject: CustomServerAsyncContext) => Promise<void> | void;
  }
}
...
declare module "h3" {
  ...
  // eslint-disable-next-line @typescript-eslint/no-empty-object-type
  interface H3EventContext extends CustomServerAsyncContext {
  }
}
  ...
  setup(_options, { nitro }) {
    ...
    addTypeTemplate({
      ...
      getContents: () => [
        ...
        "  export interface CustomServerAsyncContext {}",
        "}",
        "",
      ].join("\n"),
    });
